...
BlockingHandlingServer::BlockingHandlingServer() :
    handledCount(0)
{}
...
void BlockingHandlingServer::handleResponse(const KukaResponse &response)
{
...
void BlockingHandlingServer::handleDisconnect()
{
//    cout << "------------------------------------------------" << endl;
//    cout << "BlockingHandlingServer: Ending session." << endl;
//    cout << "------------------------------------------------" << endl;
}

void BlockingHandlingServer::createPublishers(ros::NodeHandle &n)
{
